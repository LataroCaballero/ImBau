...
**Verification depth scales with `asvs_level`** (see @/Users/laucaballero/Desktop/Lautaro/AndesCode/ImBau/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
