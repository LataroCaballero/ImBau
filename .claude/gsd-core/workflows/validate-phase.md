...
```
Agent(
  prompt="Read /Users/laucaballero/Desktop/Lautaro/AndesCode/ImBau/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/laucaballero/Desktop/Lautaro/AndesCode/ImBau/.claude/gsd-core/templates/VALIDATION.md`
