...
**Read and run** the gate + edge probe in `/Users/laucaballero/Desktop/Lautaro/AndesCode/ImBau/.claude/gsd-core/references/specless-probe-fallback.md`
...
else-branch below, per §A/§B/§C of `/Users/laucaballero/Desktop/Lautaro/AndesCode/ImBau/.claude/gsd-core/references/specless-probe-fallback.md`
