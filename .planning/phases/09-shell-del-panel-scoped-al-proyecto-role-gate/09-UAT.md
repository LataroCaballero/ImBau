...
updated: 2026-07-21T20:48:04Z
---

## Current Test

number: 1
name: Owner/developer navega el shell del proyecto en un viewport real
expected: |
  Con `pnpm dev` levantado, logueado como owner o developer, abrir `/proyectos/[id]/unidades`:
  se ven las tres tabs (Unidades / Leads / Hotspots), la tab activa muestra el indicador visual
  `aria-current="page"`, y bajo el encabezado del proyecto aparece el placeholder es-AR.
