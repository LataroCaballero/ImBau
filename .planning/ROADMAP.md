...
- [ ] 10-01-PLAN.md — Migración versionada `UNIQUE(unit_id, price_list_id)` [BLOCKING] + prueba de enforcement (GRID-05, Wave 1)
- [ ] 10-02-PLAN.md — Módulo puro `packages/api/src/excel/` (build/parse/money/dry-run/bulk) + property tests + exceljs/fast-check (GRID-03/04/06, Wave 1)
...
| 10. D1 — Grilla de unidades + Excel | v1.3 | 0/4 | Not started | - |
